...
def greeting(message):
    ...
    bot.send_message(message.from_user.id,
                  'Salom.\nBotga xush kelibsiz!\nBot sizga Fortuna Biznes korxonasiga ishga kirishda ro\'yxatdan o\'tishga yordam beradi.', reply_markup=main_markup)
...
def register_view(message):
    ...
    if message.text == 'Anketa to\'ldirish 📝':
        ...
        client.save()
        bot.send_message(message.from_user.id,
                  "Royxatdan muvaffaqiyatli o'tdingiz!", reply_markup=new_markup)
